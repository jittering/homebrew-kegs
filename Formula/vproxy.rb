...
class Vproxy < Formula
  ...
  if OS.mac?
    url "https://github.com/jittering/vproxy/releases/download/v0.6/vproxy_0.6_Darwin_x86_64.tar.gz"
    sha256 "99ef9513ae342863e2378ac46c596ad13840aa364ec58658ddc0252e60c925d2"
  end
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/jittering/vproxy/releases/download/v0.6/vproxy_0.6_Linux_x86_64.tar.gz"
    sha256 "de462e70c6e67a035ff346162b2da0355ad19fd6618d60accab5bd5f2f23816a"
  end
  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "https://github.com/jittering/vproxy/releases/download/v0.6/vproxy_0.6_Linux_arm64.tar.gz"
    sha256 "b0da07d71b75ef911b6faf87d73a0b673c7f1d90168d1b57dfb71938c41f7339"
  end
